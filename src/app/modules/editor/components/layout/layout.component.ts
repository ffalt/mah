...
import { CONSTS, MAX_LAYOUT_TILES, MIN_LAYOUT_TILES, isPlayableTileCount } from '../../../../model/consts';
...
export class LayoutComponent implements OnInit, OnChanges, OnDestroy {
	...
	readonly tileCountLimits = { min: MIN_LAYOUT_TILES, max: MAX_LAYOUT_TILES };
	totalZ = 1;
	totalY = CONSTS.mY;
	totalX = CONSTS.mX;
